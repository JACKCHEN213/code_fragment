...
if __name__ == "__main__":
    ...
    tree.export_graphviz(model, out_file='src\\iris.dot', feature_names=iris_feature_E[0:2], class_names=iris_class,
                         filled=True, rounded=True, special_characters=True)
    # 2、给定文件名
    ...
    graph.write_pdf('src\\iris.pdf')
    f = open('src\\iris.png', 'wb')
