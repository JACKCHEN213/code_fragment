...
if __name__ == '__main__':
    ...
    num_vq = 256
    im = Image.open('.\\src\\lena.png')  # son.bmp(100)/flower2.png(200)/son.png(60)/lena.png(50)
    ...
    model = KMeans(n_clusters=num_vq, n_init='auto')
    ...
    plt.imshow(vq_image)
    print('vq_image = \n', vq_image)
    Image.fromarray((vq_image * 255).astype(np.uint8)).save('src\\VQ.png')
